...
export function CombatMenu({
  ...
  const [submenu, setSubmenu] = useState<"monster" | "npc" | null>(null);
  ...
  return (
    <div className={`absolute top-11 left-4 z-50 flex items-start gap-2 ${isOpen ? "pointer-events-auto" : "pointer-events-none"}`}>
      ...
      <div
        ...
        } ${submenu ? "opacity-100 translate-x-0 pointer-events-auto" : "opacity-0 -translate-x-2 pointer-events-none"}`}
      >
        <div className="flex items-center justify-between mb-3 px-0.5">
